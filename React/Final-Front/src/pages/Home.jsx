        ...
        <FAQSection>
          ...
          <FAQList>
            <FAQItem>
              ...
              <Answer>직원의 건강과 복지에 관심이 많고, 데이터 기반으로 효율적인 사내 복지 시스템을 구축하고자 하는 모든 규모의 기업에 적합합니다.</Answer>
            </FAQItem>
            <FAQItem>
              <Question>개인 건강 데이터는 어떻게 관리되나요?</Question>
              <Answer>모든 개인 건강 데이터는 엄격한 보안을 통해 암호화되어 관리됩니다. 기업 관리자는 직원의 개별 건강 데이터를 직접 열람할 수 없으며, 오직 익명화된 통계 데이터만을 확인할 수 있습니다.</Answer>
            </FAQItem>
            <FAQItem>
              <Question>복지 포인트는 어떻게 활용할 수 있나요?</Question>
              <Answer>복지 포인트는 워케이션 우선 신청권, 제휴된 건강 용품 교환, 사내 이벤트 참여 등 다양한 형태로 활용 가능합니다. 자세한 혜택은 기업 설정에 따라 달라질 수 있습니다.</Answer>
            </FAQItem>
            <FAQItem>
              <Question>시스템 도입 절차가 궁금합니다.</Question>
              <Answer>데모 신청 후 담당자와 상담을 통해 기업 맞춤형 설정이 진행됩니다. 이후 직원 온보딩을 위한 안내와 시스템 사용 교육이 제공되며, 바로 시스템을 활용하실 수 있습니다.</Answer>
            </FAQItem>
            <FAQItem>
              <Question>모바일에서도 사용 가능한가요?</Question>
              <Answer>네, SOWM 시스템은 반응형 웹으로 개발되어 PC, 태블릿, 모바일 등 모든 기기에서 최적화된 환경으로 이용하실 수 있습니다.</Answer>
            </FAQItem>
          </FAQList>
        </FAQSection>
      </MainContent>
